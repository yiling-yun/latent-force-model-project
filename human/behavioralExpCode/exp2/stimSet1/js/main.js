...
const COMPLETION_URL = 'https://ucla.sona-systems.com';
...
function SHOW_PRACTICE() {
    PREPARE_TRIAL();
    $('#instrBox').hide();
    $('#vid1').attr('src', STIM_PATH + INSTR_PRAC_LIST[0] + STIM_TYPE);
    $('#vid2').attr('src', STIM_PATH + INSTR_PRAC_LIST[1] + STIM_TYPE);
    $('#vid3').attr('src', STIM_PATH + INSTR_PRAC_LIST[2] + STIM_TYPE);
    $('#vid1')[0].load();
    $('#vid2')[0].load();
    $('#vid3')[0].load();
