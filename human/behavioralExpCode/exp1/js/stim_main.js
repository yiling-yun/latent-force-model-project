...
// data saving
const FORMAL = false; //YY: need to check for new study
const EXPERIMENT_NAME = "HSvideo";
const SAVING_FOLDER_NAME = "labeling_1000"; //YY: need to check for new study
...
const COMPLETION_URL = "https://ucla.sona-systems.com"; //YY: need to check for new study
...
const STIM_SOURCE = "1156movies/";
const EXPT_N = 17; //YY: need to check for new study
...
instr_text[5] =
    "In this experiment, we will show you some simple animations of two triangles interacting with each other, just like the one in the example below.";
instr_text[6] =
    "This experiment contains 68 trials. In each trial, a video will show up, and you will click on the video to play.";
instr_text[7] =
...
var trial_options = {
    ...
    stimType: STIM_TYPE,
    // trialInput: Object.values(test.trialInput),
