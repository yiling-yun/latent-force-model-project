...
if __name__ == '__main__':
    ...
    train_file = '../data/charades_traj_train.csv'
    test_file = '../data/charades_traj_val.csv'
    ...
    test_videos = [t for t in test_videos if t not in infer_videos]
    train_videos = [t for t in all_videos if t not in infer_videos and t not in test_videos]

    print('--------- After filtering -------------')
    print(f"Number of train videos: {len(train_videos)}")
    print(f"Number of train videos: {len(test_videos)}")

    split_and_save(train_file, train_videos)
    split_and_save(test_file, test_videos)
